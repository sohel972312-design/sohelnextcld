...
export default function PageNotFound() {
    return (
        <div className="  flex flex-col bg-bg text-white font-body">
            ...
            <main className="relative flex flex-1 items-center justify-center overflow-hidden px-5 pt-40 pb-20 xl:pt-50">
                {/* Glow blobs */}
        ...
        <div className="pointer-events-none absolute -top-36 -right-20 w-[480px] h-[480px] rounded-full bg-cyan opacity-[0.09] blur-[110px]" />
                ...
                <div className="relative z-10 flex flex-col items-center text-center w-full">
                    {/* Badge */}
                 <div
              className="animate-fade-down inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full mb-5 sm:mb-6 text-[#c1121f] font-bold bg-[rgba(230,108,108,0.12)] border border-[rgba(230,108,108,0.25)] text-[clamp(0.6rem,0.75rem,1rem)] tracking-widest uppercase"
